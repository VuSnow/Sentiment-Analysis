...
button_start = tk.Button(container, text='Read', command=get_date_start)
button_end = tk.Button(container, text='Read', command=get_date_end)
...
def center_container(event):
    container.place(relx=0.5, rely=0.1, anchor=tk.CENTER)
